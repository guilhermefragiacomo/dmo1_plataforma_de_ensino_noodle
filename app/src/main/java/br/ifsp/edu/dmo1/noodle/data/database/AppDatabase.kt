...
@Database(entities = [Course::class, Lesson::class, LessonDocument::class, User::class, Work::class, WorkCommit::class, WorkCommitDocument::class, WorkDocument::class, Session::class, CourseUser::class], version = 8)
